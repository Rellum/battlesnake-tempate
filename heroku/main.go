...
func main() {
	...
	http.HandleFunc("/kaa", kaa.HandleIndex)
	http.HandleFunc("/kaa/start", kaa.HandleStart)
	http.HandleFunc("/kaa/move", kaa.HandleMove)
	http.HandleFunc("/kaa/end", kaa.HandleEnd)
